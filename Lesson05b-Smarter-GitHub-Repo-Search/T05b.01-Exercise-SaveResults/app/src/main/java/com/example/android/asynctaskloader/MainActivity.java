...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_JSON="searchJson";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState !=null){
            ...
            if(savedInstanceState.containsKey(SEARCH_JSON))
                mSearchResultsTextView.setText(savedInstanceState.get(SEARCH_JSON).toString());
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_JSON,mSearchResultsTextView.getText().toString());
    }
}